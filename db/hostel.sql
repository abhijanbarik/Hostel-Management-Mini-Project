...
--
-- Host: 127.0.0.1
-- Generation Time: oct 30, 2017 at 08:19 AM
...
CREATE TABLE IF NOT EXISTS `users` (
 `username` varchar(50) NOT NULL,
  ...
  `address` text NOT NULL) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=37 ;

--
-- Dumping data for table `users`
--

INSERT INTO `users` (`username`, `password`, `email`, `gender`, `mob`, `address`) VALUES
('neeraj', '3b3b8360f70b78bb4f6239078e636626', 'neeraj@gmail.com', 'm', 8800670473, ''),
('nishant', 'caf1a3dfb505ffed0d024130f58c5cfa', 'nishant@nishant.com', 'm', 9451626198, ''),
('test', '098f6bcd4621d373cade4e832627b4f6', 'test@tets.com', 'm', 9458822647, ''),
('test3', '8ad8757baa8564dc136c1e07507f4a98', 'test2@gmail.com', 'm', 9898789, 'tst test '),
('test0', '202cb962ac59075b964b07152d234b70', 'admin@gmail.com', 'f', 987897987, 'asndhasvd'),
('test123', '202cb962ac59075b964b07152d234b70', 'test2@gmail.com', 'm', 123, ''),
('ravi', '63dd3e154ca6d948fc380fa576343ba6', 'ravi@gmail.com', 'm', 901555555, 'delhi'),
('sanjeev', '98d34c1758b15b5a359b69c2b08c5767', 'sanjeevtech2@gmail.com', 'm', 9015501897, '141 delhi\r\ndhakka'),
('abhi', '98d34c1758b15b5a359b69c2b08c5767', 'abhi@gmail.com', 'm', 9015501899, 'ddd9');
